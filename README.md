...
## Índice
Principiantes
1) [¿Qué es React?](https://github.com/midudev/preguntas-entrevista-react#principiante)
2) [¿Cuáles son las características principales de React?](https://github.com/midudev/preguntas-entrevista-react#cuáles-son-las-características-principales-de-react)
3) [¿Qué significa exactamente que sea declarativo?](https://github.com/midudev/preguntas-entrevista-react#qu%C3%A9-significa-exactamente-que-sea-declarativo)
4) [¿Qué es un componente?](https://github.com/midudev/preguntas-entrevista-react#qu%C3%A9-es-un-componente)
5) [¿Qué es JSX?](https://github.com/midudev/preguntas-entrevista-react#qu%C3%A9-es-jsx)
6) [¿Cómo se transforma el JSX?](https://github.com/midudev/preguntas-entrevista-react#c%C3%B3mo-se-transforma-el-jsx)
7) [Cuál es la diferencia entre componente y elemento en React?](https://github.com/midudev/preguntas-entrevista-react#cu%C3%A1l-es-la-diferencia-entre-componente-y-elemento-en-react)
8) [¿Cómo crear un componente en React?](https://github.com/midudev/preguntas-entrevista-react#c%C3%B3mo-crear-un-componente-en-react)
9) [¿Qué son las props en React?](https://github.com/midudev/preguntas-entrevista-react#qu%C3%A9-son-las-props-en-react)
10) [¿Qué es el renderizado condicional en React?](https://github.com/midudev/preguntas-entrevista-react#qu%C3%A9-es-el-renderizado-condicional-en-react)
11) [¿Cómo puedes aplicar clases CSS a un componente en React?](https://github.com/midudev/preguntas-entrevista-react#c%C3%B3mo-puedes-aplicar-clases-css-a-un-componente-en-react)
12) [¿Cómo puedes aplicar estilos en línea a un componente en React?](https://github.com/midudev/preguntas-entrevista-react#c%C3%B3mo-puedes-aplicar-estilos-en-l%C3%ADnea-a-un-componente-en-react)
13) [¿Cómo puedo aplicar estilos de forma condicional a un componente en React?](https://github.com/midudev/preguntas-entrevista-react#c%C3%B3mo-puedo-aplicar-estilos-de-forma-condicional-a-un-componente-en-react)
14) [¿Qué es el renderizado de listas en React?](https://github.com/midudev/preguntas-entrevista-react#qu%C3%A9-es-el-renderizado-de-listas-en-react)
15) [¿Cómo añadir un evento a un componente en React?](https://github.com/midudev/preguntas-entrevista-react#c%C3%B3mo-a%C3%B1adir-un-evento-a-un-componente-en-react)
16) [¿Qué es el estado en React?](https://github.com/midudev/preguntas-entrevista-react#qu%C3%A9-es-el-estado-en-react)
17) [¿Qué son los hooks?](https://github.com/midudev/preguntas-entrevista-react#qu%C3%A9-son-los-hooks)
18) [¿Qué hace el hook useEffect?](https://github.com/midudev/preguntas-entrevista-react#qu%C3%A9-hace-el-hook-useeffect)
19) [Explica casos de uso del hook useEffect](https://github.com/midudev/preguntas-entrevista-react#explica-casos-de-uso-del-hook-useeffect)
20) [Cómo suscribirse a un evento en useEffect](https://github.com/midudev/preguntas-entrevista-react#c%C3%B3mo-suscribirse-a-un-evento-en-useeffect)
21) [¿Cómo podemos ejecutar código cuando el componente se monta?](https://github.com/midudev/preguntas-entrevista-react#c%C3%B3mo-podemos-ejecutar-c%C3%B3digo-cuando-el-componente-se-monta)
22) [¿Qué son los Fragments en React?](https://github.com/midudev/preguntas-entrevista-react#qu%C3%A9-son-los-fragments-en-react)
23) [¿Cómo puedes inicializar un proyecto de React desde cero?](https://github.com/midudev/preguntas-entrevista-react#c%C3%B3mo-puedes-inicializar-un-proyecto-de-react-desde-cero)
24) [¿Qué es React DOM?](https://github.com/midudev/preguntas-entrevista-react#qu%C3%A9-es-react-dom)

Intermedio

25) [¿Cuántos useEffect puede tener un componente?](https://github.com/midudev/preguntas-entrevista-react#cu%C3%A1ntos-useeffect-puede-tener-un-componente)
26) [¿Cómo podemos ejecutar código cuando el componente se desmonta del árbol?](https://github.com/midudev/preguntas-entrevista-react#c%C3%B3mo-podemos-ejecutar-c%C3%B3digo-cuando-el-componente-se-desmonta-del-%C3%A1rbol)
27) [Cómo puedes cancelar una petición a una API en useEffect correctamente](https://github.com/midudev/preguntas-entrevista-react#c%C3%B3mo-puedes-cancelar-una-petici%C3%B3n-a-una-api-en-useeffect-correctamente)
28) [¿Cuáles son las reglas de los hooks en React?](https://github.com/midudev/preguntas-entrevista-react#cu%C3%A1les-son-las-reglas-de-los-hooks-en-react)
29) [¿Qué diferencia hay entre useEffect y useLayoutEffect?](https://github.com/midudev/preguntas-entrevista-react#qu%C3%A9-diferencia-hay-entre-useeffect-y-uselayouteffect)
30) [¿Qué son mejores los componentes de clase o los componentes funcionales?](https://github.com/midudev/preguntas-entrevista-react#qu%C3%A9-son-mejores-los-componentes-de-clase-o-los-componentes-funcionales)
